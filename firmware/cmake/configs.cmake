...
SET_PROPERTY( DIRECTORY APPEND PROPERTY COMPILE_DEFINITIONS $<$<CONFIG:Debug>:DEBUG> $<$<CONFIG:Debug>:_DEBUG> $<$<CONFIG:Debug>:>)
...
ELSE()
	...
	SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -g -Wno-register -fno-exceptions -fno-rtti -Os")
